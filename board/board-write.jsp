        ...
        <div>
            ...
            <div class="inputArea">
            	<form method="post" >
                	...
                	<textarea cols="100" rows="18" name="content"></textarea>
                	<ul>
                		<li class="file-area">
		               		<div>
								<span>0.00 Bytes</span><button type="button"><span>첨부파일추가</span><img src="images/add.png" alt="" /></button>
							</div>
							<p>
								<label>
									<span>파일첨부</span><input type="file" name="file1" class="file"/>
								</label>
								<button type="button"><img src="images/minus.png" alt="" /></button>
								<span class="filesize"></span>
							</p>
                		</li>
                	</ul>
		            <button class="back-list" type="button">목록으로</button>
