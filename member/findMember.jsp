...
<body>
    ...
    <div id="container">
        ...
        <form class="form" name="form" method="get">
            <input type="text" class="name" name="name" placeholder="2글자 이상">
            <input type="email" class="email" name="email" placeholder="이메일을 입력하세요">
            <!-- <input type="submit" class="find_id" value="아이디 찾기"> -->
            <button type="button" class="find_id">아이디 찾기</button>
            <div id="layer_popup_id">
                <h2>아이디를 이메일로 전송하였습니다.</h2>
                <h2>이메일을 확인해 주세요.</h2>
        ...
        <form class="form" name="form" method="get">
            ...
            <button type="button" class="find_pw">비밀번호 찾기</button>
            <div id="layer_popup_pw">
                <h2>비밀번호를 이메일로 전송하였습니다.</h2>
                <h2>이메일을 확인해 주세요.</h2>
                <button type="submit" class="confirm">확인</button>
            </div>
        </form>
