...
<head>
    ...
    <link rel="stylesheet" href="css/easyLogin.css">
    ...
    <script src="js/easyLogin.js"></script>
    <script>
...
<body>
    ...
    <div id="container">
        <img src="images/easy-login.png" alt="">
        <h1>간편 로그인</h1>
        <!-- 네아로 -->
        <div id="naverIdLogin">
            <img src="images/login-naver.PNG" alt="네이버 아이디로 로그인 버튼">
        </div>
        <!-- 카아로 -->
        <a id="kakaoLogin"><img src="images/login-kakao.png" alt="카카오 아이디로 로그인 버튼"></a>
