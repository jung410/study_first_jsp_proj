...
<body>
    ...
    <div id="container">
        ...
        <form id="form" name="form" method="post">
            <input type="text" id="name" name="name" placeholder="2글자 이상">
            <span class="nameinput">2글자 이상 5글자 미만의 한글로 된 이름을 입력해주세요.</span>
            <input type="text" id="id" name="userid" placeholder="아이디를 입력하세요">
            <span class="idinput">3글자 이상 15글자 미만의 특수문자를 제외한 영문자+숫자의 조합으로 입력해주세요.</span>
            ...
            <input type="text" id="roadAddress" name="roadAddr" placeholder="도로명주소">
            ...
            <p>수신 거부</p>
            <input type="button" id="regist_ok" value="회원가입">
            <div id="layer_popup_regist">
                <h2>회원가입이 완료되었습니다.</h2>
                <h2>로그인후 이용해 주세요.</h2>
                <button type="submit" class="confirm">확인</button>
            </div>
            <input type="button" id="regist_cancle" value="가입취소" >
        </form>
    </div>
